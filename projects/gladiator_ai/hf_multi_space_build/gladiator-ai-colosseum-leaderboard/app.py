...
DEFAULT_ROLE = "leaderboard"
DEFAULT_PEERS = "https://nine1eight-gladiator-ai-colosseum-arena.hf.space,https://nine1eight-gladiator-ai-colosseum-vault.hf.space"

APP_ROLE = os.getenv("SPACE_ROLE", DEFAULT_ROLE)
PUBLIC_SPACE_NAME = os.getenv("PUBLIC_SPACE_NAME", "gladiator-ai-colosseum-leaderboard")
FEDERATION_PEERS = [
    x.strip().rstrip("/")
