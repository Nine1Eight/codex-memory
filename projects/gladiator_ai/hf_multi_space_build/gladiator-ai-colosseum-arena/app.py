...
DEFAULT_ROLE = "arena"
DEFAULT_PEERS = "https://nine1eight-gladiator-ai-colosseum-vault.hf.space,https://nine1eight-gladiator-ai-colosseum-leaderboard.hf.space"

APP_ROLE = os.getenv("SPACE_ROLE", DEFAULT_ROLE)
PUBLIC_SPACE_NAME = os.getenv("PUBLIC_SPACE_NAME", "gladiator-ai-colosseum-arena")
FEDERATION_PEERS = [
    x.strip().rstrip("/")
